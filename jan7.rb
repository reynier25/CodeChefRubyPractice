...
# To generate array B, first we chose an integer R between 1 and 106 inclusive. Note that R is not randomly generated, it will be manually selected. Then all elements of array B are chosen in range 1..R randomly.
