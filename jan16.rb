...
# Input
# First line of input will give an integer T denoting number of test cases. Then for next T lines, each line will contain two space separated integers n, s.
# Output
...
# Explanation
# Example case 1. Only possible rank list in this case is {1}, As it is already an ideal rank list, hence you need zero operations.

# Example case 2. Only possible rank list in this case is {1 2 3}, As it is already an ideal rank list, hence you need zero operations.

# Example case 3. One of the possible rank list is {1 2 2}, You can convert it into an ideal rank list by changing any 2 to 3 i.e. {1, 2, 3}, hence you need one operations.

# Example case 4. Only possible rank list is {1 1 1}, You can convert it into an ideal rank list by changing a 1 to 2 and another 1 to 3 i.e. {1, 2, 3}, hence you need two operations.
